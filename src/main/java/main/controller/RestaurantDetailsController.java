...
public class RestaurantDetailsController {
	...
	public RestaurantDetails data(
			@RequestParam(value = "id", defaultValue = "BwJnhjN-ogCmvYY864Lkww") String rest_id){
		...
		String overall_rating = restaurant.get("rating").getAsString() + " based on " 
				+ restaurant.get("review_count") + " reviews";
		...
		return new RestaurantDetails(name,phone,overall_rating,price, location, 
				open_time, close_time, photos,lat, lng);
	}
